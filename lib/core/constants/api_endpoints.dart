...
class ApiEndpoints {
  ...
  // ── Drivers / NFC ─────────────────────────────────────────────────────────
  static String driverByNfc(String tagId) =>
      '/api/courtier/drivers/nfc?tagId=$tagId';
  ...
  static String nfcTopup(String tagId) =>
      '/api/cashier/passengers/nfc/$tagId/topup';
  static String phoneTopup(String phone) =>
      '/api/cashier/passengers/phone/$phone/topup';
  ...
  static const String cashplusCredit =
      '/api/cashier/cashplus/transactions/creditwallet';
