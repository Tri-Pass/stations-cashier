class Env {
  ...
  static const String socketCluster =
      isDev ? _testSocketClusterUrl : _socketClusterUrl;
  ...
  static const String _apiDevUrl = String.fromEnvironment('API_DEV_URL',
      defaultValue: 'https://stations.wetaxi.ma');
  static const String _socketClusterUrl =
      String.fromEnvironment('SOCKET_CLUSTER_URL');
  static const String _testSocketClusterUrl =
      String.fromEnvironment('TEST_SOCKET_CLUSTER_URL');
